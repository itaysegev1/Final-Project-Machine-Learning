"""
This script trains Random Forest on the Baseline and Advanced datasets and saves
the metrics + plots (including the top-20 feature importances) to results/random_forest/.
"""
...
def _top_k_importances(model, feature_names, k):
    """
...
def _feature_importance_figure(top):
    """
    draws the bar chart of the top feature importances
    """
...
def main():
    ...
    for ds_name in DATASETS:
        ...
        # keep the Advanced fit for the feature importance plot
        if ds_name == "Advanced":
